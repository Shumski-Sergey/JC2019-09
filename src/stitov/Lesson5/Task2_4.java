...
public class Task2_4 {
    public static void main (String[] args){
        ...
        minChar = charLength[0];

        for (int i=0;i<charLength.length;i++){
            if (charLength[i]<minChar){
                minChar =charLength[i];
                minIndex = i;
            }
        }
        System.out.println("Наименьшее количество различных символов в слове " + stringarray[minIndex]);
    }
}
